  ...
  <div class="box">
   <div class="box_1">
    ...
    <div class="boxCenterList RelaArticle" align="center">
      ...
      <p style="font-size: 18px; font-weight:bold; color:#eb6100;"><?php echo $this->_var['message']['content']; ?></p>
        <div class="blank"></div>
...
?>
          <p><a class="back_urls" href="<?php echo $this->_var['url']; ?>"><?php echo $this->_var['info']; ?></a></p>
