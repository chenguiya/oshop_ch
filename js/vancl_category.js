$(function(){
	...
	/****顶级分类页幻灯片****/
	$(".Women_focusTab").slide({titCell:".FocusNum li",mainCell:".FocusTab ul",effect:"fold",autoPlay:true,titOnClassName:"hot",prevCell:".lef_Btn",nextCell:".rig_Btn"});
	...
	*/
	...
	$('.subCat2 li').mouseover(function(){
		...
		$('.subCat3 li').removeClass('active');
		$('.subCat3 .subcat_'+catid).addClass('active');
		// if (!$('.subCat3 li.active').length) {
		// 	$('.subCat3 li:first').addClass('active');
		// }
	});
